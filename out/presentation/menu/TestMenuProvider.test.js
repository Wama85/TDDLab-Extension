...
const TestMenuProvider_1 = require("./TestMenuProvider");
describe('TestMenuProvider - Integration Tests', () => {
    let menuProvider;
    beforeEach(() => {
        menuProvider = new TestMenuProvider_1.TestMenuProvider();
    });
    ...
    describe('Refresh Functionality', () => {
        it('should trigger refresh event when refresh is called', () => {
            ...
            menuProvider._onDidChangeTreeData.fire = firespy;
            // Act
    ...
    describe('TestMenuItem Class', () => {
        it('should create TestMenuItem with label only', () => {
            // Act
            const item = new TestMenuProvider_1.TestMenuItem('Test Label');
            // Assert
        ...
        it('should create TestMenuItem with label and command', () => {
            ...
            // Act
            const item = new TestMenuProvider_1.TestMenuItem('Test Label', command);
            // Assert
            expect(item.label).toBe('Test Label');
        ...
        it('should create TestMenuItem with custom collapsible state', () => {
            ...
            // Act
            const item = new TestMenuProvider_1.TestMenuItem('Test Label', undefined, collapsibleState);
            // Assert
            expect(item.label).toBe('Test Label');
...
//# sourceMappingURL=TestMenuProvider.test.js.map